...
func (r *UserRepositoryMock) GetUserByUserName(userName string) (*model.User, error) {
...
func TestUserServiceGetUserByID(t *testing.T) {
	// case 1
	UserRepo.On("GetUserByID", int64(1)).Once().Return(&model.User{UserName: "123"}, nil)
	testutil.Play(t, UserSrv, "GetUserByID", int64(1)).Match(&model.User{UserName: "123"}, nil)
...
func TestUserServiceGetUserByUserName(t *testing.T) {
	// case 1
	UserRepo.On("GetUserByUserName", "123").Once().Return(&model.User{UserName: "123"}, nil)
	testutil.Play(t, UserSrv, "GetUserByUserName", "123").Match(&model.User{UserName: "123"}, nil)

	// case 2
	UserRepo.On("GetUserByUserName", "123").Once().Return(nil, gorm.ErrRecordNotFound)
	testutil.Play(t, UserSrv, "GetUserByUserName", "123").Match(nil, gorm.ErrRecordNotFound)
}
...
func TestUserServiceCreateUser(t *testing.T) {
	// case 1
	UserRepo.On("CreateUser", &model.User{UserName: "123"}).Once().Return(&model.User{UserName: "123"}, nil)
	testutil.Play(t, UserSrv, "CreateUser", &model.User{UserName: "123"}).Match(&model.User{UserName: "123"}, nil)

	// case 2
	UserRepo.On("CreateUser", &model.User{UserName: "1234"}).Once().Return(nil, errors.New("Duplicate"))
	testutil.Play(t, UserSrv, "CreateUser", &model.User{UserName: "1234"}).Match(nil, errors.New("Duplicate"))
}
